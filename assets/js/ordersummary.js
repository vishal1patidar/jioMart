  ...
  try {
    ...
    <div class="cartDatarightside_container">
        ...
        <div class="sticky-top">
            ...
            <div class="subtoal">
                <label>MRP Total</label><span id="cart_sub_total">₹${totalPayment + savePayment
      }.00</span>
            </div>
            ...
            <div class="net-amount">
                <label>Total Amount</label><span id="cart_netpay_makepayment">₹${totalPayment - coupanPayment
      }</span>
            </div>
            <p class="save-amount cart-savings ng-star-inserted">You Save ₹${savePayment + coupanPayment
      }</p>
    ...
    data.forEach((element) => {
      ...
      div.innerHTML = `
            ...
            <div>
                ...
                <p><span>₹${element.item_final_price * element.item_quantity
        }.00</span> <span>₹${element.item_price * element.item_quantity
        }.00 </span> <span>You Save ₹${element.item_disc_price * element.item_quantity
        }.00</span> </p>
